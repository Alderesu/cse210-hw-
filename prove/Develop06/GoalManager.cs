...
{  
    ...
    {  
        ...
        {  
            ...
            Console.WriteLine("4. Negative Goal"); // New option for Negative Goal
            ...
            {  
                ...
                case "4": // New case for Negative Goal
                    ...
                    _goals.Add(new NegativeGoal(name, description, penaltyPoints));  
                    break;      
                default:  
        ...
        {  
            ...
            {  
                ...
                {
                    _score -= ((NegativeGoal)_goals[choice]).PenaltyPoints; // Deduct penalty points from the score
                }
                else
                {
                    ...
                    {  
                        ...
                        {  
                            ...
                            case "Checklist Goal":  
                                ...
                                break;  
                            case "Negative Goal":  // New case for loading Negative Goal
